...
<div>
<nav class="navbar navbar-expand-sm fixed-top justify-content-start border-bottom border-light" style="background-color: #000;">
<div class="container-fluid">
<a href="#" class="navbar-brand"> <video src="${cp}files/common/k_intro.mp4" alt="mp4" width="125" muted autoplay playsinline loop></video>
</a>
